/*
 * ZEN_simulateSignals_emxutil.c
 *
 * Code generation for function 'ZEN_simulateSignals_emxutil'
 *
 */
...
static void emxFreeStruct_struct5_T(struct5_T *pStruct)
{
  emxFree_int8_T(&pStruct->newMeasurement);
  emxFree_real_T(&pStruct->range_perfect);
  emxFree_real_T(&pStruct->azimuth_perfect);
  emxFree_real_T(&pStruct->range);
  emxFree_real_T(&pStruct->azimuth);
}

static void emxInitStruct_struct1_T(const emlrtStack *sp, struct1_T *pStruct,
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->t, 2, srcLocation, doPush);
...
static void emxInitStruct_struct5_T(const emlrtStack *sp, struct5_T *pStruct,
  const emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_int8_T(sp, &pStruct->newMeasurement, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->range_perfect, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->azimuth_perfect, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->range, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->azimuth, 2, srcLocation, doPush);
}
...
{
  emxFreeStruct_struct1_T(&pStruct->loadedTrajectory);
}
...
void emxFreeStruct_struct4_T(struct4_T *pStruct)
{
  emxFree_real_T(&pStruct->t);
  emxFree_real_T(&pStruct->position);
  emxFree_real_T(&pStruct->velocity);
  emxFreeStruct_struct5_T(&pStruct->sonar);
}
...
{
  emxInitStruct_struct1_T(sp, &pStruct->loadedTrajectory, srcLocation, doPush);
}
  ...
  emlrtRTEInfo *srcLocation, boolean_T doPush)
{
  emxInit_real_T(sp, &pStruct->t, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->position, 2, srcLocation, doPush);
  emxInit_real_T(sp, &pStruct->velocity, 2, srcLocation, doPush);
  emxInitStruct_struct5_T(sp, &pStruct->sonar, srcLocation, doPush);
}
...
/* End of code generation (ZEN_simulateSignals_emxutil.c) */
